  ...
  return (
    <main className="awards">
      <div className="award__topbar">
        ...
        />
        <h1 data-aos="fade-up" data-aos-offset="100" data-aos-duration="1000">
          جوایز و افتخارات
        </h1>
      </div>
      {/* first award */}
      <section className="award__content award1">
        ...
        <div className="award__text">
          <h3 data-aos="fade-up" data-aos-offset="100" data-aos-duration="1000">
            برترین تولید کننده ساعت در سال 1400
          </h3>
          <h6 data-aos="fade-up" data-aos-offset="100" data-aos-duration="1000">
